...
/**
 * <p>Title: MD5</p>
 * <p>Description: MD5 算法的Java Bean</p>
...
public final class MD5 {
  ...
  public String getMD5ofStr(String inbuf) {
    return getMD5ofStr(inbuf.getBytes());
  }

  public String getMD5ofStr(byte[] aByte) {
    md5Init();
    md5Update(aByte, aByte.length);
    md5Final();
    digestHexStr = "";
  ...
  public byte[] getMD5Bytes(String inbuf) {
    return getMD5Bytes(inbuf.getBytes());
  }

  public byte[] getMD5Bytes(byte[] aByte) {
    md5Init();
    md5Update(aByte, aByte.length);
    md5Final();
    return digest;
